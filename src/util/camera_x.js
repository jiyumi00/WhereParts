...
import { View, StyleSheet, TouchableOpacity, Image, NativeModules, BackHandler, Text, Dimensions } from 'react-native';
            ...
            this.capturedView.current.measure((fx, fy, width, height, px, py) => {
                ...
                if (this.props.blur == true) {
                    this.setState({
                        ...
                        bottomBlur: { top: (this.target.top + this.target.height), left: 0, width: "100%", height:"100%", backgroundColor: "rgba(0,0,0,0.6)", position: "absolute", zIndex: 2 },
                    });
                }
    ...
    render() {
        ...
        return (
            <View style={inStyle.container}>
                <View style={inStyle.viewBodyLayout} onLayout={(event) => this.getViewSize(event)} ref={this.cameraView}>
                    <Camera
                        ref={this.camera}
                    ...
                    {this.props.hasOwnProperty("upperText") && this.props.hasOwnProperty("cutImageStyle") && this.props.hasOwnProperty("onCutImageListener") && this.state.capturedViewVisible == true && <>
                        ...
                        <View style={[this.state.topTextView, inStyle.topTextViewStyle]} /*ref={this.topTextView}*/>
               ...
               {/*  <View style={inStyle.viewBottomLayout}>
                    <View style={inStyle.cameraLayout}>
                        <TouchableOpacity style={inStyle.btn_camera} onPress={this.shutterButtonClicked}>
                            <View style={{ width: 53, height: 53, borderWidth: 2,borderColor:'#7A7A7A', borderRadius: 50 }}></View>
                        </TouchableOpacity>
                    </View>
                </View> */}
            </View>
